#ifndef NARVAL_THRUSTER_MANAGER_MODEL_PARSER_H
#define NARVAL_THRUSTER_MANAGER_MODEL_PARSER_H
...
struct ModelParser
{
  ...
  ModelParser(const std::string &control_frame) : control_frame{control_frame}
  {
    ...
    const auto rsp_node(std::make_shared<rclcpp::Node>("narval_thruster_manager_rsp_" + frame_name));
